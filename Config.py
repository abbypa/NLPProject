...
WORD_OCCURRENCE_MIN_HITS_TO_MATCH = dict([('person', 10), ('company', 15), ('place', 10)])
DUCKDUCK_COMPANY_MIN_HITS_TO_MATCH = 2
DICTIONARY_NORMAL_WORD_GRADE = 150
DICTIONARY_NE_GRADE = 10
FACEBOOK_QUERY_LIMIT = 150
FACEBOOK_NE_MIN_COUNT = 45
FACEBOOK_BALANCE_OUT_NAME = 25
...
UPPERCASE_CLASSIFIER_WEIGHT = 1
COMPANY_DUCK_DUCK_GO_CLASSIFIER_WEIGHT = 1
